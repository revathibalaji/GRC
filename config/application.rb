...
CMS_CONFIG = {       
  "SECRET_TOKEN" => "363123gfg63g2f66hf23d533f2665gf23fr6e123fg6",
  "COMPANY" => "Company, Inc.",
  "COMPANY_LOGO" => nil,
...
module CmsRails
  class Application < Rails::Application
    ...
    # ActiveRecord::SessionStore::Session.table_name = 'cms_session_table'
    # ActiveRecord::SessionStore::Session.primary_key = 'session_id'
    # ActiveRecord::SessionStore::Session.data_column_name = 'cms_session_data'
    # ActiveRecord::SessionStore::Session.connection = establish_connection("sessions_#{RAILS_ENV}")
