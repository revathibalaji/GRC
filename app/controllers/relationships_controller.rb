...
#  end
  ...
  private
    ...
    def list_form_context
      ...
      object = object_real_model.constantize.find_by_id(params[:object_id])
    ...
    def update_object(relationship, params)
      ...
      if params[:related_side].present?
        ...
        related = related_type.find_by_id(params[:related_id])
        ...
        object = object_type.find_by_id(params[:object_id])
